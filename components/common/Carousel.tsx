...
const Carousel: React.FC<CarouselProps> = ({
  ...
  }, [enableAutoScroll, totalImages, isUserInteracting, autoScrollInterval, clearTimers]);
  ...
  useEffect(() => {
    ...
    return () => clearTimers();
  }, [currentIndex, enableAutoScroll, isUserInteracting, totalImages, startAutoScroll, clearTimers]);
  ...
  if (images.length === 0) {
    return (
      <View style={[styles.container, { height, backgroundColor: '#f8f9fa' }]}>
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.indicator,
                  {
                    backgroundColor: isActive ? '#0d9488' : 'rgba(255, 255, 255, 0.5)',
                    width: isActive ? 24 : 8,
