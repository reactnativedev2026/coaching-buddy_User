  ...
  return (
    <View className="flex-1 bg-secondary">
      <ScrollView contentContainerClassName="">
        ...
        <ImagesCarousel images={Array(15).fill(college.images.banner[0])} />
                ...
                <View className="flex-row items-center">
                  ...
                  <Text className="text-primary/50 text-sm font-pSemiBold mt-1">
                    ...
                    {college.comments != null
                      ? getFormattedReviewsCount(college.comments)
                      : null}
                    )
                  </Text>
                </View>
            ...
            <View className="gap-2">
              ...
              <View className="flex-row">
                ...
                <Text className="text-primary/50 font-pSemiBold text-sm">
                  {college.address.area}, {college.address.city}, India
                </Text>
              </View>
            </View>
          </View>
...
function Description({ college }: { college: CollegeType }) {
  ...
  return (
    <View className="px-4 py-6 gap-4">
      <View className="gap-2">
        <Text className="text-primary font-pSemiBold text-lg">Contact</Text>
        ...
        <View className="flex-row items-center justify-between">
          ...
          <View className="flex-row items-center gap-4">
            ...
            >
              <FontAwesome name="phone" size={30} color="#0d9488" />
            </CustomButton>
          </View>
        </View>
      </View>
      ...
      <View>
        <Text className="text-primary font-pSemiBold text-lg">Description</Text>
      ...
      <View className="flex-row items-center justify-between border-b-hairline border-b-primary/50 pb-4">
        <Text className="text-primary font-pSemiBold text-lg">Address</Text>
      ...
      <View>
        <Text className="text-primary font-pRegular text-sm">
          {college.address.area} {college.address.city} {college.address.nearBy}{" "}
  ...
  return (
    <View className="px-4 py-6">
      ...
      <View className="flex-row items-center gap-1 mb-4">
        <Text className="text-primary font-pSemiBold text-sm">Gallery</Text>
        <Text className="text-accent1 font-pSemiBold text-sm">
...
//     );
  ...
  return (
    <View className="px-4 py-6 gap-4">
      <View className="flex-row items-center justify-between">
        <Text className="text-primary font-pSemiBold text-sm">Review</Text>
          ...
          <View className="gap-1 px-4 py-2 border-2 border-primary/5 bg-secondary shadow-md rounded-xl">
            <View className="flex-row items-center justify-between">
              <View className="flex-row items-center gap-2">
                <CustomImage
                  image={{
                    uri: getImageURI(college.images.logo[0]),
                  }}
                  className="w-16 aspect-square rounded-full items-center justify-center"
                  imageClassName="w-full h-full"
                />
  ...
  return (
    <View className="px-4 py-6 gap-4">
            ...
            <View className="flex-1 gap-2">
              ...
              <View>
                <Text className="text-accent1 text-sm font-pSemiBold">
                  ₹{item.sellingPrice}{" "}
                  {Number(item.discount) > 0 ? `(${item.discount}% off)` : null}
                </Text>

                {Number(item.sellingPrice) < Number(item.price) && (
                  <View className="flex-row">
              ...
              <CustomButton
                ...
                onPress={() => {
                  setIsPlaceOrderConfirmationModalVisible(true);
      ...
      <AlreadyBookedWithThisCourseModal
        ...
        handleModalClose={() => setIsAlreadyBookedThisCourseModalVisible(false)}
      />
    </View>
  );
}
